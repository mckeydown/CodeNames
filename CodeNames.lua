...
help = {
    ...
    },
    {
        ...
        "<font size='9'><N2>(feel free to contact me any suggestions, bugs or feedbacks)</N2></font>\n\n"..
        "<p align='center'><b><font color='#f5d8b6' size='13'>HOSTER</font></b>\n"..
        "<font size='12'>[NIL]</font>\n\n"..
        "<b><font color='#f5d8b6' size='13'>GRAND ADVISOR</font></b>\n"..
        "<font size='12'><V>Lays</V><G>#1146</G></font>\n\n"..
        "<b><font color='#f5d8b6' size='13'>TESTERS</font></b>\n"..
        "<font size='12'><V>Kucukstarr</V><G>#3074</G>, <V>Fatihmilano</V><G>#0000</G>, <V>Hotspotower</V><G>#0000</G>, <V>Neonstrayzer</V><G>#0000</G>, <V>Ulubilge</V><G>#0000</G></font>",
    }
},
    ["tr"] = {
        {
        ...
        " Bu kelimelerden bazıları <font color='#8f2b1c'><b>Kırmızı Takım</b></font>'a, bazıları ise <font color='#3284a3'><b>Mavi Takım</b></font>'a atanır. Her takımdan bir oyuncu Spymaster'dır ve sadece Spymaster'lar hangi kelimelerin hangi yakıma ait olduğunu görebilir."..
    ...
    },
    {
        ...
        "<font size='12'><V>Mckeydown</V><G>#0000</G></font>\n"..
        "<font size='9'><N2>(öneri, hata veya geri bildirim için benimle iletişime geçebilirsiniz)</N2></font>\n\n"..
        "<p align='center'><b><font color='#f5d8b6' size='13'>HOSTLAYAN</font></b>\n"..
        "<font size='12'>[NIL]</font>\n\n"..
        "<b><font color='#f5d8b6' size='13'>BÜYÜK DANIŞMAN</font></b>\n"..
        "<font size='12'><V>Lays</V><G>#1146</G></font>\n\n"..
...
function checkBan(action, name)
    if action == "ban" then
        for n, player in pairs(tfm.get.room.playerList) do 
            for i = 1, #banList do
                if n == banList[i] then
                    ui.addImage("banned", "182bc8b716a.png", "&9999", -1000, -500,n,50,50)
                end
            end
        end
    end
...
function hideHelp(name)
    for i=textAreas.help.tab1, textAreas.help.tab1 + #help[roomLang] + 4 do
...
function hideCommands(name)
    for i=textAreas.commands.title, textAreas.commands.title + #help[roomLang] + 3 do
        ui.removeTextArea(i, name)
    end
...
function eventTextAreaCallback(id, name, e)
    ...
    if e:sub(1,7) == "number_" then
        ...
        if nums > whichteam then tfm.exec.chatMessage(string.format(""), playerName) return end
        currentClueNum = nums
        if nums < 6 then
...
function gameOver(team, isBlack)
    ...
    showRoundCards(true)
    if isBlack then 
        addInfo(string.format(translations[roomLang].blackGameOver, team))
    return end
